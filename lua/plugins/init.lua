return {
  {
    ---@package nvim-mini/mini.icons
    --- NOTE: See `:help mini.icons` or https://github.com/nvim-mini/mini.icons for more info
    'nvim-mini/mini.icons',
    version = false,
  },
  {
    ---@package folke/snacks.nvim
    --- NOTE: See `:help snacks` or https://github.com/folke/snacks.nvim for more info
    'folke/snacks.nvim',
    lazy = false,
    priority = 1000,
    ---@type snacks.Config
    opts = {
      ...
      dashboard = {
        sections = {
          ...
          { title = "  It's not a bug; it's an undocumented feature.", padding = 1, align = 'center' },
        },
      },
  ...
  {
    ---@package folke/todo-comments.nvim
  ...
  },
  {
    ...
    --- NOTE: See `:help mini.ai` or https://github.com/nvim-mini/mini.ai for more info
    'nvim-mini/mini.ai',
    version = false,
    opts = {
      n_lines = 500,
  ...
  },
  {
    ...
    --- NOTE: See :hlep mini.pairs or https://github.com/nvim-mini/mini.pairs for more info
  ...
  },
  {
    ...
    --- NOTE: See `:help mini.surround` or https://github.com/nvim-mini/mini.surround for more info
    'nvim-mini/mini.surround',
    version = false,
    opts = {
      mappings = {
        add = '<leader>ms', -- Add surrounding in Normal and Visual modes
    ...
    keys = {
      { '<leader>ms', desc = 'Add Surrounding' },
      { '<leader>md', desc = 'Delete Surrounding' },
      { '<leader>mf', desc = 'Find Surrounding' },
      { '<leader>mF', desc = 'Find Surrounding (left)' },
      { '<leader>mh', desc = 'Highlight Surrounding' },
      { '<leader>mr', desc = 'Replace Surrounding' },
      { '<leader>mn', desc = 'Update Surrounding Lines' },
    },
    config = function(_, opts)
